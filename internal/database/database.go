...
func (d *Database) Migrate() error {
	...
	d.Exec("CREATE INDEX IF NOT EXISTS idx_presence_user_id ON presence(user_id)")
	d.Exec("CREATE INDEX IF NOT EXISTS idx_presence_room_id ON presence(room_id)")
	d.Exec("CREATE INDEX IF NOT EXISTS idx_presence_last_seen ON presence(last_seen DESC)")
